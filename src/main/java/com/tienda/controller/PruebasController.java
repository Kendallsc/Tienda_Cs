...
public class PruebasController {
    ...
    @GetMapping("/listado/{idCategoria}") // Se pasa el valor por el URL
    ...
    @PostMapping("/query4")
    public String query4(@RequestParam("existenciasInf") double existenciasInf, @RequestParam("existenciasSup") double existenciasSup,Model model) {
